...
lemma↔ₐ-dist i y₁ .y₁ b w | .w | inj₂ (inj₂ (p , q , refl)) | .w | inj₂ (inj₂ (proj₄ , proj₅ , refl)) | .w | inj₂ (inj₁ x) | .i | inj₂ (inj₁ (refl , f , refl)) | .w | inj₂ (inj₂ (o , n , refl)) | k | res₅ | .i | inj₂ (inj₁ (refl , proj₂ , refl)) = ?
lemma↔ₐ-dist i y₁ .y₁ b w | .w | inj₂ (inj₂ (p , q , refl)) | .w | inj₂ (inj₂ (proj₄ , proj₅ , refl)) | .w | inj₂ (inj₂ y) | .i | inj₂ (inj₁ (refl , f , refl)) | .w | inj₂ (inj₂ (o , n , refl)) | k | res₅ | .i | inj₂ (inj₁ (refl , proj₂ , refl)) = ?
lemma↔ₐ-dist x₁ y₁ a b w | .w | inj₂ (inj₂ (p , q , refl)) | .w | inj₂ (inj₂ (proj₄ , proj₅ , refl)) | j | res₂ | i | inj₂ (inj₂ y) | .j | res₄ | k | res₅ | .i | inj₂ (inj₁ (refl , proj₂ , refl)) = {!!}
lemma↔ₐ-dist x y₁ a b w | .w | inj₂ (inj₂ (p , q , refl)) | .w | inj₂ (inj₂ (proj₁ , proj₂ , refl)) | h | res₂ | i | res₃ | j | res₄ | k | res₅ | l | inj₂ (inj₂ y) = {!!}
